...
import static com.nil.test.sdk.sampleapp.util.Constant.LONDON_STADIUM;
import static com.nil.test.sdk.sampleapp.util.Constant.O2_ARENA;
...
public class ConcertsAdapter extends RecyclerView.Adapter<ConcertsAdapter.ViewHolder> {
    ...
    private ArrayList<Concert> getMockData() {
        ...
        Concert concert = new Concert("Beyonce & Jay.Z", "London Stadium, London", "June 15-16, 2018  |  18:00", R.drawable.pic_beynonce, dates, LONDON_STADIUM);
        concerts.add(concert);

        dates = new ArrayList<>();
        dates.add("18:00, June 14, 2018 @ London Stadium");
        dates.add("18:00, June 17, 2018 @ London Stadium");
        concert = new Concert("Ed Sheeran", "London Stadium, London", "June 14-17, 2018  |  18:00", R.drawable.pic_ed, dates, LONDON_STADIUM);
        concerts.add(concert);

        dates = new ArrayList<>();
        dates.add("17:00, June 18, 2018 @ O2 Arena");
        dates.add("17:00, June 20, 2018 @ O2 Arena");
        concert = new Concert("Kanye West", "O2 Arena, London", "June 18-20, 2018 | 17:00", R.drawable.pic_kanye, dates, O2_ARENA);
        concerts.add(concert);
